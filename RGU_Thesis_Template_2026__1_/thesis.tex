...
\usepackage{graphicx,parskip,float,array}
...
\hypersetup{
    pdftitle    = {COL334 Assignment 1, Parts A and B: Mapping the Machine You Live On},
    pdfauthor   = {Tejasvi Shrivastava, Yashvardhan Singh Chaudhary},
    pdfsubject  = {Computer Networks},
    pdfkeywords = {traceroute, campus network, RTT, delay, topology, packet capture, Wireshark, anomaly detection},
...
% NOTE: straight double quote, for reproducing Wireshark display filters verbatim
\newcommand{\qq}{\char`\"}
...
\title{\huge{Mapping the Machine You Live On}\\[0.3em]\normalsize COL334 Computer Networks: Assignment 1, Parts A and B}
...
% Part B: the stakeout
\include{partb/b1_twodays}
\include{partb/b2_hunt}
\include{partb/b3_argue}
