...
distance to the named campus, T3/T5 from public IP geolocation, i.e.\ the resolved IP's
registered location) and are not independently verified against ground truth.
