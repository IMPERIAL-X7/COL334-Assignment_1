...
deals with how to use the \LaTeX \space system. \textcolor{red}{ERASE OR COMMENT (I.E. ADD A \% SYMBOL) FROM THESIS.TEX (LINE 111) TO DISAPPEAR THIS SECTION BEFORE YOU SUBMIT YOUR WORK!}
